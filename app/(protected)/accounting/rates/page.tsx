    ...
    <div className="p-6 space-y-10">
      ...
      <div className="bg-white p-6 rounded-xl shadow border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <LabeledInput label="Client ID" value={clientId} onChange={(e) => setClientId(e.target.value)} />
          <LabeledInput label="Service Type" value={serviceType} onChange={(e) => setServiceType(e.target.value)} />
          <LabeledInput label="Rate per KG" value={rate} onChange={(e) => setRate(e.target.value)} />
          <LabeledInput label="Payment Terms" value={terms} onChange={(e) => setTerms(e.target.value)} />
        </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <LabeledInput label="Filter by Client ID" value={filterClientId} onChange={(e) => setFilterClientId(e.target.value)} />
          <LabeledInput label="Filter by Service Type" value={filterType} onChange={(e) => setFilterType(e.target.value)} />
        </div>
